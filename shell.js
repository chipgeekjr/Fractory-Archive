...
ko.bindingHandlers.shell_render = {
	...
	update: function(element, valueAccessor) {
		...
		if(shell.zoom_in()) {
			...
			///web.archive.org/web/20201011014523/https://element.style.transform = 'scale(0.0)';
			_.defer(function() {
...
/*
playback timings (ms):
  captures_list: 385.074
  exclusion.robots: 0.106
  exclusion.robots.policy: 0.097
  RedisCDXSource: 11.177
  esindex: 0.014
  LoadShardBlock: 351.297 (3)
  PetaboxLoader3.datanode: 373.515 (4)
  CDXLines.iter: 20.001 (3)
  load_resource: 208.307
  PetaboxLoader3.resolve: 99.797
*/